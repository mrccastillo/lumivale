      ...
      <section className="bg-white px-6 py-16 pt-32">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-sm leading-7 text-[var(--lumivale-muted)] sm:text-base">
            Gain valuable insight from our team on relevant industry news, emerging
            trends, and practical marketing strategies to help you stay ahead.
          </p>
        </div>
      </section>
          ...
          <div>
            <div>
              ...
              <h2 className="mt-3 text-[1.75rem] font-semibold leading-tight sm:text-[1.9rem]">
                Practical industry insights to accelerate your growth
              </h2>
            </div>
          </div>
