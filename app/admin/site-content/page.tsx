...
export default async function SiteContentPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-5xl">
      ...
      <p className="mt-3 text-sm leading-7 text-[var(--lumivale-muted)]">Customize your homepage hero, About Us page, results, navigation branding, footer, and footer call to action.</p>
