  ...
  return <section id="conversion" data-nav-surface="dark" className={styles.closing}>
    <div className={styles.wrap}>
      <Reveal data-testid="conversion-reveal" className={styles.closingTop}>
        <div data-scroll-reveal><p className={styles.eyebrow}>{content.footerCtaPrompt}</p><h2>{lastSpace >= 0 ? heading.slice(0, lastSpace + 1) : ""}<span>{heading.slice(lastSpace + 1)}</span></h2></div>
    ...
    <footer aria-label="Site footer" data-theme="dark">
      <div className={styles.wrap}>
        <div className={styles.footerInfo} data-scroll-reveal>
